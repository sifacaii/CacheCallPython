/*
	...
	Copyright (c) 1997-2010 by InterSystems.
...
#define	CACHE_MAXLOSTSZ	3641144                                 /* SAP1198 */
...
#define	CACHE_ERNOCATCH		183	/* <NOCATCH> */
...
#define CACHE_ERMAX		197	/* Maximum error number */
...
#define	CACHEPUSHEXSTRA(sptr)	CachePushExStr(sptr)		/* KMK497+ */
...
#define	CACHEPOPEXSTRA(sstrp)	CachePopExStr(sstrp)			/* KMK497+ */
...
#define	CACHEPUSHPROPERTYA(oref,plen,pptr) CachePushProperty(oref,plen,pptr)
...
#define	CACHEPUSHEXSTRCVTH(sptr)	CachePushExStrW(sptr)		/* SAP1026 */
#define	CachePushRtnH(rflag,tlen,tptr,nlen,nptr)			\
	CachePushRtnW(rflag,tlen,tptr,nlen,nptr)
#define	CACHEPUSHRTNXH(rflag,tlen,tptr,off,elen,eptr,nlen,nptr)		\
	CachePushRtnXW(rflag,tlen,tptr,off,elen,eptr,nlen,nptr)
...
#define	CACHEEXSTRNEWA(zstr,size) CacheExStrNew(zstr,size)		/* KMK495+ */
